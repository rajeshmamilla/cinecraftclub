        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/explore/trending" className="hover:text-primary transition-colors">Trending</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 flex-wrap items-center">
              <a 
                href="https://www.linkedin.com/in/rajeshmamilla" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/rajeshmamilla/cinecraftclub" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-muted-foreground hover:text-primary transition-colors"
                title="GitHub"
              ...
              <a 
                href="mailto:rajeshmamilla206@gmail.com" 
